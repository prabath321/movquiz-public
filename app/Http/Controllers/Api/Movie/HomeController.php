...
class HomeController extends BaseController
{
	...
	$data1 = $modelClass::where('published_at',$todaydate)->where('type','tv')
        ...
        "message"=>'Success',
        "featured"=>array(
            array('index'=>1,'title'=>'Upcoming','img'=>$data[0]['image_url']),
            array('index'=>2,'title'=>'Now Playing','img'=>$data[1]['image_url']),
            array('index'=>3,'title'=>'Popular','img'=>$data[3]['image_url']),
    ...
    public function page($page=1){
        ...
        $this->createImage($data1,"upcoming".$page."_");
        $this->createImage($data2,"now_playing".$page."_");
        $this->createImage($data3,"top_rated".$page."_");
        $this->createImage($data4,"popular".$page."_");
    }
